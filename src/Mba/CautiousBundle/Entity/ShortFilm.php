...
/**
 * Mba\CautiousBundle\Entity\ShortFilm
 *
 * @ORM\Table(name="shoer_film")
 * @ORM\Entity(repositoryClass="Mba\CautiousBundle\Entity\ShortFilmRepository")
 * @Vich\Uploadable
 */
class ShortFilm {
    ...
    /**
     * @var date $short_film_date
     *
     * @ORM\Column(name="short_film_date", type="date")
     */
    private $short_film_date;
     ...
     * Set short_film_date
     *
     * @param date $shortFilmDate
     */
    public function setShortFilmDate($shortFilmDate)
    {
        $this->short_film_date = $shortFilmDate;
    }
     ...
     * @return date 
     */
    public function getShortFilmDate()
    {
        return $this->short_film_date;
    }
}