...
class Page
{
     ...
     * Set background
     *
     * @param Mba\CautiousBundle\Entity\Background $background
     */
    public function setBackground(\Mba\CautiousBundle\Entity\Background $background)
    {
     ...
     * Get background
     *
     * @return Mba\CautiousBundle\Entity\Background 
     */
